...
export class DatabasesPage {
  ...
  databases: DatabaseItem[] = [
    {
      name: 'Access Science',
      logoUrl: 'https://www.accessscience.com/images/accessscience-logo.png',
    ...
    },
    {
      ...
      logoUrl: 'https://www.accessengineeringlibrary.com/content/images/access-engineering-logo.png',
      showFallback: false, expanded: false,
      description: 'Biblioteca digital de ingeniería de McGraw-Hill con libros, normas y herramientas de cálculo.',
    },
    {
      name: 'AGORA',
      logoUrl: 'https://www.fao.org/fileadmin/templates/agora/img/agora-logo.png',
      showFallback: false, expanded: false,
      description: 'Acceso a investigación en agricultura, alimentación y ciencias afines para países en desarrollo.',
    },
    {
      name: 'Agronet',
      logoUrl: 'https://www.agronet.gov.co/Noticias/PublishingImages/agronet.png',
      showFallback: false, expanded: false,
    ...
    },
    {
      ...
      logoUrl: 'https://ambientalex.info/wp-content/uploads/2020/01/logo-ambientalex.png',
      showFallback: false, expanded: false,
      description: 'Base de datos especializada en legislación y jurisprudencia ambiental de Colombia y Latinoamérica.',
    },
    {
      name: 'ARDI',
      logoUrl: 'https://www.wipo.int/export/sites/www/ardi/en/img/ardi-logo.png',
      showFallback: false, expanded: false,
    ...
    {
      name: 'ASCE',
      logoUrl: 'https://www.asce.org/siteassets/asce-logo.png',
      showFallback: false, expanded: false,
    ...
    },
    {
      ...
      logoUrl: 'https://www.wdl.org/static/img/wdl-logo.png',
      showFallback: false, expanded: false,
      description: 'Colección de documentos históricos y culturales de todo el mundo en múltiples idiomas.',
    },
    {
      name: 'Cambridge University Press',
      logoUrl: 'https://www.cambridge.org/core/cambridge-core/public/images/logo_core_white.png',
      showFallback: false, expanded: false,
    ...
    },
    {
      ...
      logoUrl: 'https://about.proquest.com/globalassets/proquest/logos/proquest-logo.png',
      showFallback: false, expanded: false,
      description: 'Base de datos gratuita de ProQuest con investigaciones sobre COVID-19 y coronavirus.',
    },
    {
      name: 'Digitalia English',
      logoUrl: 'https://www.digitaliapublishing.com/img/logo-digitalia.png',
      showFallback: false, expanded: false,
    ...
    {
      name: 'eBooks 7-24',
      logoUrl: 'https://ebooks7-24.com/img/logo724.png',
      showFallback: false, expanded: false,
    ...
    },
    {
      ...
      logoUrl: 'https://connect.ebsco.com/rs/335-GCG-667/images/EBSCO_logo.png',
      showFallback: false, expanded: false,
